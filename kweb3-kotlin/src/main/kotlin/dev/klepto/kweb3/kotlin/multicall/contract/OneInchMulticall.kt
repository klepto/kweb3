...
/**
 * Implementation of
 * [1inch Multicall](https://github.com/1inch/multicall)
...
interface OneInchMulticall : MulticallExecutor {
    ...
    /**
     * Aggregates all [calls] into a single request and returns
     * an array containing return data bytes of each call. If
     * remaining gas is ever lower than the [gasBuffer], returns
     * all the available results up to that point and the index of
     * the last successful call.
     *
     * @param calls the array of calls to be aggregated
     * @param gasBuffer the amount of gas to be left in the
     *     transaction before returning
     * @return the response tuple containing results and last
     ...
     * @param data the encoded call data to be sent to the smart
     *     contract
     */
     ...
     * @param lastSuccessIndex the index of the last successful
     *     call
     */
